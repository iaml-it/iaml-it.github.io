---
title: "Transformers in Vision: a Recap"
description: |
...
Important works adapting transformers (and self-attention) to vision include Attention Augmented Convolutional Networks @aacn, Stand-Alone Self-Attention models[@sasa] (SASA models), DETR[@detr], Visual Transformers[@visual_transformer] and LambdaNetworks[@lambda]; as well as Image Transformers[@image_transformer] and Axial Transformers[@axial] in the generative domain.
